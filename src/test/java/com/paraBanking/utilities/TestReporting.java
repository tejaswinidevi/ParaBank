package com.paraBanking.utilities;
...
public class TestReporting extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		String repName="paraBankTest-Report-"+timeStamp+".html";
		...
		sparkReporter.config().setDocumentTitle("ParaBanking Automation"); // Tile of report
